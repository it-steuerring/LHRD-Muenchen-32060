...
resource dscJoin 'Microsoft.Compute/virtualMachines/extensions@2021-11-01' = {
  ...
  properties: {
    ...
    settings: {
      ModulesUrl: 'https://github.com/it-steuerring/LHRD-Muenchen-32060/raw/refs/heads/main/scripts/Join-Domain.zip'
...
resource registerHost 'Microsoft.Compute/virtualMachines/extensions@2021-11-01' = {
  ...
  properties: {
    ...
    settings: {
      fileUris: [
        'https://github.com/it-steuerring/LHRD-Muenchen-32060/raw/refs/heads/main/scripts/Register-Host.zip'
      ]
